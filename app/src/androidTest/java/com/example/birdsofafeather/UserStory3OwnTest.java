...
public class UserStory3OwnTest {
    ...
    public void userStory3OwnTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.student_detail_row_text), withText("2021,Winter,CSE,101"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))),
                        isDisplayed()));
        textView2.check(matches(withText("2021,Winter,CSE,101")));
